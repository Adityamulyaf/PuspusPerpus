<?php
/**
 * Create Book View for PuspusPerpus
 */
...
<div class="page-header" style="margin-bottom: 24px;">
    <div>
        <h2 class="page-title">Tambah Koleksi Buku</h2>
        <p class="page-subtitle">Silakan isi formulir di bawah ini dengan lengkap untuk menambahkan buku baru.</p>
    </div>
    <div>
...
<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="stat-card" style="opacity: 1; padding: 32px;">
            ...
            <!-- Global database or auth failure warnings -->
            ...
            <form action="index.php?route=books/create" method="POST" id="book-form" novalidate>
                    ...
                    <div style="display: flex; gap: 24px; margin-top: 8px;">
                        <label style="display: flex; align-items: center; gap: 8px; font-size: 14px; cursor: pointer;">
                            <input 
                                ...
                                <?php echo (!isset($old['status']) || $old['status'] === 'Tersedia') ? 'checked' : ''; ?>
                            >
                            <span>Tersedia</span>
                        </label>
                        ...
                        <label style="display: flex; align-items: center; gap: 8px; font-size: 14px; cursor: pointer;">
                            <input 
                                ...
                                value="Dipinjam" 
                                style="accent-color: var(--primary);"
                                <?php echo (isset($old['status']) && $old['status'] === 'Dipinjam') ? 'checked' : ''; ?>
                            >
                            <span>Dipinjam</span>
                        </label>
                    </div>
